...
Breadcrumbs::for('dashboard.users.index', function ($breadcrumb) {
    ...
    $breadcrumb->push(trans('accounts::users.plural'), route('dashboard.users.index'));
});

Breadcrumbs::for('dashboard.users.create', function ($breadcrumb) {
    $breadcrumb->parent('dashboard.users.index');
    $breadcrumb->push(trans('accounts::users.actions.create'), route('dashboard.users.create'));
});
...
Breadcrumbs::for('dashboard.users.edit', function ($breadcrumb, $user) {
    ...
    $breadcrumb->push(trans('accounts::users.actions.edit'), route('dashboard.users.edit', $user));
});
