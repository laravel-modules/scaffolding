...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ahmed/code/pim/public/storage' => 'string',
...
'crud-generator.arabicWords.brand','crud-generator.arabicWords.product','crud-generator.arabicWords.feedback','database.default','database.connections.sqlite.driver',
...
'filesystems.links./home/ahmed/code/pim/public/storage','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory','hashing.argon.threads',
'hashing.argon.time','hashing.rehash_on_login','lang-generator.defaultLang','lang-generator.lang.auth','lang-generator.lang.pagination',
...
'locales.js.file_path','logging.default','logging.deprecations','logging.channels.stack.driver','logging.channels.stack.channels',
...
'services.slack.notifications.channel','services.mailgun.domain','services.mailgun.secret','services.mailgun.endpoint','services.pusher.beams_instance_id',
'services.pusher.beams_secret_key','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'translatable.translations_wrapper','view.paths','view.compiled','concurrency.default','debugbar.enabled',
...
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','dashboard.admins.trashed','dashboard.admins.trashed.show','dashboard.admins.restore','dashboard.admins.forceDelete',
'dashboard.admins.index','dashboard.admins.create','dashboard.admins.store','dashboard.admins.show','dashboard.admins.edit',
'dashboard.admins.update','dashboard.admins.destroy','dashboard.customers.trashed','dashboard.customers.trashed.show','dashboard.customers.restore',
'dashboard.customers.forceDelete','dashboard.customers.index','dashboard.customers.create','dashboard.customers.store','dashboard.customers.show',
'dashboard.customers.edit','dashboard.customers.update','dashboard.customers.destroy','dashboard.feedback.trashed','dashboard.feedback.trashed.show',
'dashboard.feedback.restore','dashboard.feedback.forceDelete','dashboard.feedback.read','dashboard.feedback.unread','dashboard.feedback.index',
'dashboard.feedback.show','dashboard.feedback.destroy','dashboard.locale','dashboard.home','dashboard.delete.selected',
'dashboard.forceDelete.selected','dashboard.restore.selected','dashboard.settings.index','dashboard.settings.update','dashboard.backup.download',
...
'breadcrumbs::tailwind','breadcrumbs::uikit','flash::message','flash::modal','laravel-exceptions-renderer::components.card',
...
'translatable::validation.translatableUnique','translatable::validation.translatableExist','BsForm::attachment.download','BsForm::countries.AW','BsForm::countries.AF',
'BsForm::countries.AO','BsForm::countries.AI','BsForm::countries.AX','BsForm::countries.AL','BsForm::countries.AD',
'BsForm::countries.AE','BsForm::countries.AR','BsForm::countries.AM','BsForm::countries.AS','BsForm::countries.AQ',
'BsForm::countries.TF','BsForm::countries.AG','BsForm::countries.AU','BsForm::countries.AT','BsForm::countries.AZ',
'BsForm::countries.BI','BsForm::countries.BE','BsForm::countries.BJ','BsForm::countries.BQ','BsForm::countries.BF',
'BsForm::countries.BD','BsForm::countries.BG','BsForm::countries.BH','BsForm::countries.BS','BsForm::countries.BA',
'BsForm::countries.BL','BsForm::countries.BY','BsForm::countries.BZ','BsForm::countries.BM','BsForm::countries.BO',
'BsForm::countries.BR','BsForm::countries.BB','BsForm::countries.BN','BsForm::countries.BT','BsForm::countries.BV',
'BsForm::countries.BW','BsForm::countries.CF','BsForm::countries.CA','BsForm::countries.CC','BsForm::countries.CH',
'BsForm::countries.CL','BsForm::countries.CN','BsForm::countries.CI','BsForm::countries.CM','BsForm::countries.CD',
'BsForm::countries.CG','BsForm::countries.CK','BsForm::countries.CO','BsForm::countries.KM','BsForm::countries.CV',
'BsForm::countries.CR','BsForm::countries.CU','BsForm::countries.CW','BsForm::countries.CX','BsForm::countries.KY',
'BsForm::countries.CY','BsForm::countries.CZ','BsForm::countries.DE','BsForm::countries.DJ','BsForm::countries.DM',
'BsForm::countries.DK','BsForm::countries.DO','BsForm::countries.DZ','BsForm::countries.EC','BsForm::countries.EG',
'BsForm::countries.ER','BsForm::countries.EH','BsForm::countries.ES','BsForm::countries.EE','BsForm::countries.ET',
'BsForm::countries.FI','BsForm::countries.FJ','BsForm::countries.FK','BsForm::countries.FR','BsForm::countries.FO',
'BsForm::countries.FM','BsForm::countries.GA','BsForm::countries.GB','BsForm::countries.GE','BsForm::countries.GG',
'BsForm::countries.GH','BsForm::countries.GI','BsForm::countries.GN','BsForm::countries.GP','BsForm::countries.GM',
'BsForm::countries.GW','BsForm::countries.GQ','BsForm::countries.GR','BsForm::countries.GD','BsForm::countries.GL',
'BsForm::countries.GT','BsForm::countries.GF','BsForm::countries.GU','BsForm::countries.GY','BsForm::countries.HK',
'BsForm::countries.HM','BsForm::countries.HN','BsForm::countries.HR','BsForm::countries.HT','BsForm::countries.HU',
'BsForm::countries.ID','BsForm::countries.IM','BsForm::countries.IN','BsForm::countries.IO','BsForm::countries.IE',
'BsForm::countries.IR','BsForm::countries.IQ','BsForm::countries.IS','BsForm::countries.IL','BsForm::countries.IT',
'BsForm::countries.JM','BsForm::countries.JE','BsForm::countries.JO','BsForm::countries.JP','BsForm::countries.KZ',
'BsForm::countries.KE','BsForm::countries.KG','BsForm::countries.KH','BsForm::countries.KI','BsForm::countries.KN',
'BsForm::countries.KR','BsForm::countries.KW','BsForm::countries.LA','BsForm::countries.LB','BsForm::countries.LR',
'BsForm::countries.LY','BsForm::countries.LC','BsForm::countries.LI','BsForm::countries.LK','BsForm::countries.LS',
'BsForm::countries.LT','BsForm::countries.LU','BsForm::countries.LV','BsForm::countries.MO','BsForm::countries.MF',
'BsForm::countries.MA','BsForm::countries.MC','BsForm::countries.MD','BsForm::countries.MG','BsForm::countries.MV',
'BsForm::countries.MX','BsForm::countries.MH','BsForm::countries.MK','BsForm::countries.ML','BsForm::countries.MT',
'BsForm::countries.MM','BsForm::countries.ME','BsForm::countries.MN','BsForm::countries.MP','BsForm::countries.MZ',
'BsForm::countries.MR','BsForm::countries.MS','BsForm::countries.MQ','BsForm::countries.MU','BsForm::countries.MW',
'BsForm::countries.MY','BsForm::countries.YT','BsForm::countries.NA','BsForm::countries.NC','BsForm::countries.NE',
'BsForm::countries.NF','BsForm::countries.NG','BsForm::countries.NI','BsForm::countries.NU','BsForm::countries.NL',
'BsForm::countries.NO','BsForm::countries.NP','BsForm::countries.NR','BsForm::countries.NZ','BsForm::countries.OM',
'BsForm::countries.PK','BsForm::countries.PA','BsForm::countries.PN','BsForm::countries.PE','BsForm::countries.PH',
'BsForm::countries.PW','BsForm::countries.PG','BsForm::countries.PL','BsForm::countries.PR','BsForm::countries.KP',
'BsForm::countries.PT','BsForm::countries.PY','BsForm::countries.PS','BsForm::countries.PF','BsForm::countries.QA',
'BsForm::countries.RE','BsForm::countries.RO','BsForm::countries.RU','BsForm::countries.RW','BsForm::countries.SA',
'BsForm::countries.SD','BsForm::countries.SN','BsForm::countries.SG','BsForm::countries.GS','BsForm::countries.SH',
'BsForm::countries.SJ','BsForm::countries.SB','BsForm::countries.SL','BsForm::countries.SV','BsForm::countries.SM',
'BsForm::countries.SO','BsForm::countries.PM','BsForm::countries.RS','BsForm::countries.SS','BsForm::countries.ST',
'BsForm::countries.SR','BsForm::countries.SK','BsForm::countries.SI','BsForm::countries.SE','BsForm::countries.SZ',
'BsForm::countries.SX','BsForm::countries.SC','BsForm::countries.SY','BsForm::countries.TC','BsForm::countries.TD',
'BsForm::countries.TG','BsForm::countries.TH','BsForm::countries.TJ','BsForm::countries.TK','BsForm::countries.TM',
'BsForm::countries.TL','BsForm::countries.TO','BsForm::countries.TT','BsForm::countries.TN','BsForm::countries.TR',
'BsForm::countries.TV','BsForm::countries.TW','BsForm::countries.TZ','BsForm::countries.UG','BsForm::countries.UA',
'BsForm::countries.UM','BsForm::countries.UY','BsForm::countries.US','BsForm::countries.UZ','BsForm::countries.VA',
'BsForm::countries.VC','BsForm::countries.VE','BsForm::countries.VG','BsForm::countries.VI','BsForm::countries.VN',
'BsForm::countries.VU','BsForm::countries.WF','BsForm::countries.WS','BsForm::countries.YE','BsForm::countries.ZA',
'BsForm::countries.ZM','BsForm::countries.ZW','BsForm::validation.country_not_configured','BsForm::validation.invalid','test::blogs.attributes.body',
'test::blogs.attributes.tags','test::blogs.placeholders.body','test::blogs.placeholders.tags','test::blogs.notes.tags','backup::notifications.exception_message',
